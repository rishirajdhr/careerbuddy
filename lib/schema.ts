...
const BasicsSchema = z.object({
  ...
  phone: z.string().optional().describe("Your phone number, e.g. 712-117-2923"),
...
const EducationSchema = z.object({
  ...
  startDate: DateSchema.optional().describe("The start date of your education"),
...
const PublicationSchema = z.object({
  ...
  summary: z.string().optional().describe("A brief summary of the publication"),
});
...
const VolunteerSchema = z.object({
  ...
  position: z
    .string()
    .optional()
    .describe("Your position in the organization, e.g. Volunteer, Coordinator"),
  ...
  summary: z
    .string()
    .optional()
    .describe("A summary of your responsibilities during your volunteer work"),
...
const LanguageSchema = z.object({
  ...
  fluency: z
    .string()
    .optional()
    .describe("The level of fluency in the language, e.g. Fluent, Beginner"),
});
...
const ReferenceSchema = z.object({
  ...
  name: z
    .string()
    .optional()
    .describe("The name of the person giving the reference, e.g. Tony Stark"),
...
export const ResumeSchema = z.object({
  ...
  /** Your languages */
  languages: z.array(LanguageSchema).optional().describe("Languages you speak"),
